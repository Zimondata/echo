class ExpandRemindersForSmartReminders < ActiveRecord::Migration[8.0]
  def change
    ...
    add_column :reminders, :ai_context, :jsonb, default: {} # Additional context for AI
    add_column :reminders, :action_buttons, :jsonb, default: [] # Interactive buttons for Telegram
